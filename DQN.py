...
class DQN():
    ...
    def perceive(self, state, action, reward, next_state, done):
        ...
        one_hot_state = np.zeros(6)  # 轉成one-hot型式
        one_hot_state[state] = 1

        one_hot_nextstate = np.zeros(6)  # 轉成one-hot型式
    ...
    def trans_discrete_state(self, todayCash):
        ...
        # category = [0,10000000, 13000000, 15000000, 17846836.5, 18775829, 19000000, 20000000, 23000000, 25000000, 26312565.85,
        #             28000000, 29000000, 30000000, 32951914.5, 35000000, 38000000, 40000000, 42000000, 50000000, 10000000000]

        op_labels = np.arange(0, len(category)-1)
